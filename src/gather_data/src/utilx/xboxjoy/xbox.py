...
class Joystick:
    ...
    # Usage:
    #     x,y = joy.leftStick()
    def leftStick(self,deadzone=1000):
        self.refresh()
    ...
    # Usage:
    #     x,y = joy.rightStick() 
    def rightStick(self,deadzone=1000):
        self.refresh()
